...
export default function ProfileDashboard() {
  ...
  const { data: submissionsData } = useMySubmissions(1, 5);
    console.log("this is submissions data : ", submissionsData)
  ...
  return (
    <div className="space-y-6">
      <div className="bg-linear-to-r from-primary/3 to-secondary/5 dark:from-primary/1 dark:to-secondary/2 border rounded-xs p-6">
        <h1 className="text-2xl lg:text-3xl 2xl:text-4xl font-normal mb-2 tracking-[1px]">
          Welcome back,{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {/* Problems Solved */}
        <Card className="bg-card/10 rounded-xs">
